...
public class Killer_Start {
	...
	// 플레이어
		...
		public static void K_Start() { // 킬러를 선택 할 시 시작
			Killer Player = new Killer(); //플레이어 객체 생성
			P_Life = Player.getLife();  // 킬러 체력 저장
			...
			if(computer == 1) {
				...
				InGame_Print.Selected_K(); // 선택된 화면 출력 함수
				...
				try {
					...
					System.out.println("\n\n\n\n\n\n\n");
					System.out.println("\t\t\t당신(킬러)은 이 결투에서 승리했습니다!!!\n");
					System.out.println("\n\n\n\n\n\n\n\n");
					}
					else if(P_Life <= C_Life) {
						System.out.println("\n\n\n\n\n\n\n");
						System.out.println("\t\t\t당신(킬러)은 이 결투에서 패배 했습니다!!!\n");
						System.out.println("\n\n\n\n\n\n\n\n");
						}
